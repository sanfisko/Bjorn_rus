...
""")
    ...
    def start_wifi_auto_connect(self, handler):
        """Запуск сервиса автоподключения к WiFi"""
        try:
            # Запускаем сервис
            command = "sudo systemctl start wifi-auto-connect.service"
            ...
            if result.returncode == 0:
                ...
                handler.send_header("Content-type", "application/json")
                handler.end_headers()
                handler.wfile.write(json.dumps({"status": "success", "message": "WiFi автоподключение запущено"}).encode('utf-8'))
            else:
                handler.send_response(500)
                handler.send_header("Content-type", "application/json")
                handler.end_headers()
                handler.wfile.write(json.dumps({"status": "error", "message": f"Ошибка запуска: {result.stderr}"}).encode('utf-8'))
        except Exception as e:
            handler.send_response(500)
            handler.send_header("Content-type", "application/json")
            handler.end_headers()
    ...
    def stop_wifi_auto_connect(self, handler):
        """Остановка сервиса автоподключения к WiFi"""
        try:
            # Останавливаем сервис
            command = "sudo systemctl stop wifi-auto-connect.service"
            result = subprocess.run(command, shell=True, capture_output=True, text=True)
            ...
            if result.returncode == 0:
                ...
                handler.send_header("Content-type", "application/json")
                handler.end_headers()
                handler.wfile.write(json.dumps({"status": "success", "message": "WiFi автоподключение остановлено"}).encode('utf-8'))
            else:
                handler.send_response(500)
                handler.send_header("Content-type", "application/json")
                handler.end_headers()
                handler.wfile.write(json.dumps({"status": "error", "message": f"Ошибка остановки: {result.stderr}"}).encode('utf-8'))
        except Exception as e:
            handler.send_response(500)
            handler.send_header("Content-type", "application/json")
            handler.end_headers()
    ...
    def enable_wifi_auto_connect(self, handler):
        """Включение автозапуска сервиса автоподключения к WiFi"""
        try:
            # Включаем автозапуск сервиса
            command = "sudo systemctl enable wifi-auto-connect.service"
            result = subprocess.run(command, shell=True, capture_output=True, text=True)
            ...
            if result.returncode == 0:
                ...
                handler.send_header("Content-type", "application/json")
                handler.end_headers()
                handler.wfile.write(json.dumps({"status": "success", "message": "WiFi автоподключение включено в автозапуск"}).encode('utf-8'))
            else:
                handler.send_response(500)
                handler.send_header("Content-type", "application/json")
                handler.end_headers()
                handler.wfile.write(json.dumps({"status": "error", "message": f"Ошибка включения автозапуска: {result.stderr}"}).encode('utf-8'))
        except Exception as e:
            handler.send_response(500)
            handler.send_header("Content-type", "application/json")
            handler.end_headers()
    ...
    def disable_wifi_auto_connect(self, handler):
        """Отключение автозапуска сервиса автоподключения к WiFi"""
        try:
            # Отключаем автозапуск сервиса
            command = "sudo systemctl disable wifi-auto-connect.service"
            result = subprocess.run(command, shell=True, capture_output=True, text=True)
            ...
            if result.returncode == 0:
                ...
                handler.send_header("Content-type", "application/json")
                handler.end_headers()
                handler.wfile.write(json.dumps({"status": "success", "message": "WiFi автоподключение отключено из автозапуска"}).encode('utf-8'))
            else:
                handler.send_response(500)
                handler.send_header("Content-type", "application/json")
                handler.end_headers()
                handler.wfile.write(json.dumps({"status": "error", "message": f"Ошибка отключения автозапуска: {result.stderr}"}).encode('utf-8'))
        except Exception as e:
            handler.send_response(500)
            handler.send_header("Content-type", "application/json")
            handler.end_headers()
    ...
    def get_wifi_auto_connect_status(self, handler):
        """Получение статуса сервиса автоподключения к WiFi"""
        try:
            # Проверяем статус сервиса
            status_command = "sudo systemctl is-active wifi-auto-connect.service"
            status_result = subprocess.run(status_command, shell=True, capture_output=True, text=True)
            
            enabled_command = "sudo systemctl is-enabled wifi-auto-connect.service"
            enabled_result = subprocess.run(enabled_command, shell=True, capture_output=True, text=True)
